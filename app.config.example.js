export const config = {
  public: {
    ...
    tebex: {
      publicToken: process.env.VITE_TEBEX_PUBLIC_TOKEN || 'your_tebex_public_token_here'
    }
  },
  
  private: {
    tebex: {
      privateKey: process.env.VITE_TEBEX_PRIVATE_KEY || 'your_tebex_private_key_here_keep_secret'
    }
  }
};
